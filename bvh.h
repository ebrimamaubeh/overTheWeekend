#ifndef OVERTHEWEEKEND2_BVH_H
#define OVERTHEWEEKEND2_BVH_H
...
bool bvh_node::hit(const ray &r, float tmin, float tmax, hit_record &rec) const {
    if (box.hit(r, tmin, tmax)) {
        ...
        bool is_hit_left = left->hit(r, tmin, tmax, left_rec);
        bool is_hit_right = right->hit(r, tmin, tmax, right_rec);
